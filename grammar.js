...
module.exports = grammar({
    ...
    conflicts: $ => [
        ...
        [$.InvocationExpression, $.UnaryMoveExpression, $.BinaryExpressionRelational],
        [$.InvocationExpression, $.UnaryMoveExpression, $.BinaryExpressionRelational],
        ...
        [$.InvocationExpression, $.BitwiseExpressionOr, $.BinaryExpressionRelational],
        [$.InvocationExpression, $.BitwiseExpressionXor, $.BinaryExpressionRelational],
        [$.InvocationExpression, $.NilCoalescingExpression, $.BinaryExpressionRelational],
        [$.InvocationExpression, $.MultiplicativeExpression, $.BinaryExpressionRelational],
        [$.InvocationExpression, $.AdditiveExpression, $.BinaryExpressionRelational],
        [$.InvocationExpression, $.BitwiseExpressionShift, $.BinaryExpressionRelational],
        [$.InvocationExpression, $.BitwiseExpressionAnd, $.BinaryExpressionRelational],
    ...
    rules: {
       ...
       // blockComment: _ => /\/[*]+([^*]|([*][^/]))*[*]+\//,
        ...
        VariableDeclaration: $ => prec(P.precedenceDeclaration, seq(
        ...
        _Parameters: $=> prec.left(seq(commaSep1( $.Parameter),  optional($._hiddenComma),)),
        ...
        nestedFunctionDeclaration: $ => prec.left( P.precedenceDeclaration, seq(
            field("Access", optional($.Access)),
            $._Fun,
            field("Identifier", $.Identifier),
        ...
        ImportDeclaration: $ => prec(P.precedenceDeclaration,seq(
            $._Import,
        ...
        CompositeDeclaration: $ => prec(P.precedenceDeclaration, seq(
            field("Access", $.Access),
        ...
        InterfaceDeclaration: $ => prec(P.precedenceDeclaration, seq(
            field("Access", $.Access),
            field("CompositeKind", $.CompositeKind),
            'interface',
            field("Identifier", $.Identifier),
        ...
        EventDeclaration: $ => prec(P.precedenceDeclaration,seq(
            field("Access", $.Access),
            'event',
            field("Identifier", $.Identifier),
            field("ParameterList", $.ParameterList)
        ...
        EnumDeclaration: $ => prec(P.precedenceDeclaration,seq(
            field("Access", $.Access),
            'enum',
            field("Identifier", $.Identifier),
            $._SemiColon,
        ...
        SpecialFunctionDeclaration: $ => prec(P.precedenceDeclaration, seq(
            field("FunctionDeclaration", $.FunctionDeclaration_)
        )),

        FunctionDeclaration: $ =>  prec(P.precedenceDeclaration, seq(
            field("Access", $.Access),
        ...
        transactionDeclaration: $ => prec(P.precedenceDeclaration, seq(
            'transaction',
        ...
        pragmaDeclaration: $ => prec(P.precedenceDeclaration,seq(
            '#', $.expression
        )),
        ...
        FieldDeclaration: $ => prec(P.precedenceDeclaration, seq(
            field("Access", $.Access),
        ...
        Members: $ => seq(
            field("Declarations", $._MemberOrNestedDeclaration),
        ),

        _MemberOrNestedDeclaration: $ =>  repeat1(seq(choice(
            $.FieldDeclaration,
           ...
           seq(
               ...
               optional(
                    ...
                    repeat(
                        seq(
                            '.',
                            field("NestedIdentifiers",$.Identifier)
                        )
                    )
                )
            ),
        ...
        EmitStatement: $ => seq(
            'emit',
            field("InvocationExpression", $.InvocationExpression),
        ),
        ...
        NestedExpression: $ => prec(P.precedenceAccess,
            seq(
                $._OpenParen,
                field("Expression", $.expression),
                $._CloseParen
        ...
        MemberExpression: $ => prec(P.precedenceAccess,
            seq(
                field("Expression", $.expression),
        ...
        IndexExpression: $ => prec(P.precedenceAccess,
            seq(
        ...
        InvocationExpression: $ => prec(P.precedenceAccess,
            seq(
        ...
        //postfix
        ForceExpression: $ => prec(P.precedenceUnaryPostfix,
            seq(
                field("Expression", $.expression),
                token.immediate( '!' ),
            ),
        ...
        //prefix
        UnaryMoveExpression: $ => prec(P.precedenceUnaryPrefix,
            seq(
        ...
        //unary
        NegateExpression: $ => prec(P.precedenceUnaryPrefix,
            seq(
                '!',
                field("Expression", $.expression)
            ),
        ...
        CreateExpression: $ => prec(P.precedenceUnaryPrefix,
            seq(
                $._Create,
                field("InvocationExpression", $.InvocationExpression)
            ),
        ...
        DestroyExpression: $ => prec(P.precedenceUnaryPrefix,
            seq(
                $._Destroy,
                field("Expression", $.expression)
            )
        ...
        //TODO: check
        ReferenceExpression: $ => prec(P.precedenceUnaryPrefix,
            seq(
                $._ReferenceAnnotation,
                field("Expression", $.expression),
        ...
        CastingExpression: $ => prec(P.precedenceCasting,
            seq(
                field("Expression", $.expression),
        ...
        MultiplicativeExpression: $ => prec.left(P.precedenceMultiplication,
            seq(
        ...
        AdditiveExpression: $ => prec.left(P.precedenceAddition,
            seq(
                field("Left", $.expression),
        ...
        BitwiseExpressionShift: $ => prec.left(P.precedenceBitwiseShift,
            seq(
                field("Left", $.expression),
        ...
        BitwiseExpressionAnd: $ => prec.left(P.precedenceBitwiseAnd,
            seq(
                field("Left", $.expression),
        ...
        BitwiseExpressionXor: $ => prec.left(P.precedenceBitwiseXor,
            seq(
                field("Left", $.expression),
        ...
        BitwiseExpressionOr: $ => prec.left(P.precedenceBitwiseOr,
            seq(
                field("Left", $.expression),
        ...
        NilCoalescingExpression: $ => prec.right(P.precedenceNilCoalescing,
            seq(
                field("Left", $.expression),
        ...
        BinaryExpressionRelational: $ => prec(P.precedenceComparison,
            seq(
                field("Left", $.expression),
        ...
        BinaryExpressionEquality: $ => prec.left(P.precedenceComparisonEqual,
            seq(
                field("Left", $.expression),
        ...
        BinaryExpressionAnd: $ => prec.left(P.precedenceLogicalAnd,
            seq(
                field("Left", $.expression),
        ...
        BinaryExpressionOr: $ => prec.left(P.precedenceLogicalOr,
            seq(
                field("Left", $.expression),
        ...
        //Ternary precedence: ? :*/
        ConditionalExpression: $ => prec.right(P.precedenceTernary,
            seq(
                field("Test", $.expression),
                '?',
        ...
        IdentifierExpression: $=> prec.left(P.precedenceLiteral,
            field("Identifier",
                choice(
                    $.Identifier,
                )
        ...
        StringExpression: $=> prec.left(P.precedenceLiteral,
            seq(
        ...
        BooleanExpression: $=> prec(P.precedenceLiteral,
            seq(
                field("Value",$.BooleanLiteral)
            ),
        ),

        NilLiteral: _ => 'nil',

        NilExpression: $=> prec(P.precedenceLiteral,
            seq(
                field("Value",$.NilLiteral)
            ),
        ),
        ...
        PathExpression: $=> prec(P.precedenceLiteral,
            seq(
                $._PathSeparator,
        ...
        FixedPointExpression: $=> prec(P.precedenceLiteral,
            seq(
                field("Value",$.FixedPointLiteral)
            ),
        ),
        ...
        IntegerExpression: $=> prec(P.precedenceLiteral,
            choice(
        ...
        ArrayExpression: $ => prec(P.precedenceLiteral,
            seq(
                '[',
                field("Values", commaSep($.expression)),
                ']'
            ),
        ),

        DictionaryExpression: $ => prec(P.precedenceLiteral,
            seq(
                $._OpenCurly,
